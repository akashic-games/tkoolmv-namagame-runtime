...
import { Window_ShopCommand } from "../windows/WindowShopCommand";
import { Window_ShopNumber } from "../windows/WindowShopNumber";
import { Window_ShopSell } from "../windows/WindowShopSell";
import { Window_ShopStatus } from "../windows/WindowShopStatus";
...
export class Scene_Shop extends Scene_MenuBase {
	...
	constructor() {
		super();
		if (Object.getPrototypeOf(this) === Scene_Shop.prototype) {
			this.initialize();
		}
	}
	...
	prepare(goods: any[], purchaseOnly: boolean) {
		this._goods = goods;
