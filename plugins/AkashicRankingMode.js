...
(function () {
    // パラメータ取得
    var parameters = PluginManager.parameters("AkashicRankingMode");
    ...
    // タイトル画面を自動的に飛ばす処理
    var _timerId = null;
    var _sceneTitleStart = Scene_Title.prototype.start;
    ...
    // スコアを反映させる処理
    var _gameVariablesSetValue = Game_Variables.prototype.setValue;
    ...
    if (prohibitMenu) {
        var _sceneMapCallMenu_1 = Scene_Map.prototype.callMenu;
        ...
        var _gameInterpretercommand351_1 = Game_Interpreter.prototype.command351;
    ...
    var _sceneMapCreateDisplayObjects = Scene_Map.prototype.createDisplayObjects;
